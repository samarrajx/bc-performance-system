                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full">
                                <thead className="bg-gradient-to-r from-green-50 to-emerald-50">
                                    <tr>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Agent ID</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">BC Comm</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Corp Comm</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Net Comm</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">TDS ({commissions[0]?.tds_percent}%)</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">TDS Amount</th>
                                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Net Payable</th>
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    {commissions.map((comm) => (
                                        <tr key={comm.id} className="hover:bg-gray-50 transition">
                                            <td className="px-6 py-4 text-sm text-gray-900 font-medium">{comm.agent_id}</td>
                                            <td className="px-6 py-4 text-sm text-gray-700">₹{comm.bc_comm.toFixed(2)}</td>
                                            <td className="px-6 py-4 text-sm text-gray-700">₹{comm.corp_comm.toFixed(2)}</td>
                                            <td className="px-6 py-4 text-sm text-gray-700">₹{comm.net_commission_raw.toFixed(2)}</td>
                                            <td className="px-6 py-4 text-sm text-gray-700">{comm.tds_percent.toFixed(2)}%</td>
                                            <td className="px-6 py-4 text-sm text-gray-700">₹{comm.tds_amount.toFixed(2)}</td>
                                ...
                                <tfoot className="bg-gradient-to-r from-gray-50 to-slate-50">
