    ...
    <AdminLayout>
      <div className="mb-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-green-600 via-teal-600 to-cyan-600 bg-clip-text text-transparent mb-2">
              Agents Management
            </h1>
            ...
            <table className="w-full">
              <thead className="bg-gradient-to-r from-green-50 to-teal-50">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">Joining Date</th>
                ...
                {filteredAgents.length === 0 ? (
                  ...
                  filteredAgents.map((agent) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-sm text-gray-700 font-medium">{agent.agent_name}</td>
                      ...
                      <td className="px-6 py-4 text-sm text-gray-500 font-mono">{agent.assigned_device_id || 'Unassigned'}</td>
                      <td className="px-6 py-4 text-sm text-gray-700">{agent.joining_date}</td>
